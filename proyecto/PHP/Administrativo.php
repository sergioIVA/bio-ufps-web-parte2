                    ...
                    <tbody>
                        <?php
                          ...
                          include "blob.php";
                                ...
                                $result=$controlador->mostrarAdministrativos();
                                ...
                                $i=1;
                                           ...
                                           ."</td><td>".$r['cargo']."</td><td>".$r['correo']."</td><td>".$r['telefono']."</td><td><form action=\"ModificarAdministrativo.php\" method=\"post\"><input type=\"hidden\" name=\"administrativo\" value=\"".$r['cedula']."\">"
                                           ."<input class=\"btn btn-info editar\" type=\"submit\"  value=\"Modificar\"></form></td>"
                                           ."<td><form action=\"EliminarAdministrativo.php\" method=\"post\"><input type=\"hidden\" name=\"eliminar\" value=\"".$r['cedula']."\">"
