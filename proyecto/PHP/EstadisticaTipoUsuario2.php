...
?>
<div class="row">
<h2>Generar Estadistica Tipo Usuario</h2>
                  <ul class="nav">
          <div class="row">
                <div class="x_content">Selecciona el rango que desee
                  <br><br>
                  <form class="form-horizontal" action="EstadisticaTipoUsuario2.php" method="post" >
                      <fieldset>
...
<form action="EstadisticaTipoUsuario2.php" method="post">
...
$controlador = new ControladorAdministrador();
 ?>
    ...
    if ($rango != null) {
        ...
        $titulo = "Frecuencia por tipo de usuario en fecha:" . $rango . "";
        $result = $controlador->estadisticaEspecificaTipoUsuario($rango);
        while ($r = mysqli_fetch_array($result)) {

            echo "['" . $r['tipoUsuario'] ."'," . $r['cuantos'] . "],";
        }
    } else {
        $titulo = "Frecuencia  Total en tipo de usuario";
        $result = $controlador->estadisticaGeneralTipoUsuario();
        while ($r = mysqli_fetch_array($result)) {
