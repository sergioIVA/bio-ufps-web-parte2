...
?>
<script>
    function modificarExterno(primaria, nombre, cedula, cargo, correo, telefono) {
...
<div class="">
    ...
    <div class="row">
        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            ...
            include "blob.php";
            $cedula = $_POST['externo'];
            $controlador = new ControladorAdministrador();
            $result = $controlador->mostrarExterno($cedula);

            $r = mysqli_fetch_array($result);
            ?>  
            <div class="x_panel">
                <div class="x_title">
                    <h2>Modificar Externo</h2>
                    <div class="clearfix"></div>
                </div>
                <div class="x_content">
                    <br />
                    ...
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" >
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="text" id="correo" name="Correo" required="required"   class="form-control col-md-7 col-xs-12" value="<?php echo $r['correo'] ?>">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <div align="center" class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                                <a class="btn btn-danger" href="Externo.php">Cancelar</a>
                                <input type="button" onclick="modificarExterno(document.getElementById('primaria').value, document.getElementById('nombre').value, document.getElementById('cedula').value, document.getElementById('cargo').value, document.getElementById('correo').value, document.getElementById('telefono').value)" value="Modificar"  class="btn btn-success"/>
                            </div>
                        </div>
